  ...
  const categories: DropdownCategory[] = [
    {
      ...
      items: [
        { label: 'Laser Hair Reduction', href: '/unwanted-hair', desc: 'Painless US-FDA triple-wavelength laser' },
        { label: 'Bridal Dermatology Packages', href: '/bridal-dermatology', desc: 'Curated pre-wedding bridal glow regimens' },
        { label: 'Hollywood Peel', href: '/hollywood-peel', desc: 'Instant red carpet laser clarity facial' },
        { label: 'Carbon Peel', href: '/carbon-peel', desc: 'Laser carbon pore cleansing & oil control' },
        { label: 'Q Switched Laser Skin Rejuvenation', href: '/laser-toning', desc: 'Non-ablative collagen toning & luster' },
        { label: 'Q Switched Laser Pigmentation Removal', href: '/dark-spot-and-pigment-reduction', desc: 'Freckle, sun spot & melasma clearance' },
        { label: 'Micro Needling and Radio Frequency (MNRF)', href: '/scar-removal', desc: 'EndyMed 3DEEP dermal remodeling' },
        { label: 'Fractional Resurfacing (FSR)', href: '/skin-resurfacing-texture', desc: 'Ablative-fractional texture renewal' },
        { label: 'Pro Shaper for Arms Contouring', href: '/body-contouring', desc: 'RF thermal tightening & fat reduction' },
        { label: 'Pro Shaper for Jawline Contouring', href: '/body-contouring', desc: 'Submental definition & jowl sculpting' },
        { label: 'iFine for Under Eye Rejuvenation', href: '/dark-circles', desc: 'Delicate peri-orbital RF smoothing' },
        { label: 'OxyJet MediFacial', href: '/oxyjet-medifacial', desc: 'Pressurized pure oxygen & serum infusion' },
        { label: 'Hydra MediFacial', href: '/hydra-medifacial', desc: 'Deep vortex pore extraction & hydration' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { label: 'PRP for Hair Growth', href: '/hair-loss', desc: 'Autologous platelet-rich plasma therapy' },
        { label: 'GFC for Hair Growth', href: '/hair-loss', desc: 'Next-gen Growth Factor Concentrate' },
        { label: 'PRF for Hair Growth', href: '/hair-loss', desc: 'Fibrin matrix sustained growth factor release' },
        { label: 'Mesotherapy for Hair Growth', href: '/hair-loss', desc: 'Direct follicular micro-nutrient delivery' },
        { label: 'Low Level Laser Therapy (LLLT)', href: '/hair-loss', desc: 'Photobiomodulation cellular ATP energy' },
        { label: 'Medical Grade LED for Hair Growth', href: '/hair-loss', desc: 'Clinical phototherapy scalp stimulation' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Baby Food Allergies', href: '/food-allergy', desc: 'Cutaneous allergy diagnostics' },
      ],
    },
    {
